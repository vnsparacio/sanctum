...
export const workModeTools=Object.freeze([
 ...
 Object.freeze({name:'worktree_patch',description:'Apply one bounded raw Git unified diff to the current isolated Work Mode task. The patch string must contain --- a/path, +++ b/path, and @@ hunk lines; Markdown fences and *** Begin Patch wrappers are invalid. Traversal, symlinks, hard links, Git internals and symlink-mode patches are rejected.',parameters:object({task_id:task,patch:{type:'string',minLength:1,maxLength:48000}},['task_id','patch'])}),
