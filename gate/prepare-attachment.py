...
if __name__ == "__main__":
    try:
        ...
        raise SystemExit(
            "Attachment preparation failed. Nothing was sent. Check the supported types and limits in README.md."
        )
