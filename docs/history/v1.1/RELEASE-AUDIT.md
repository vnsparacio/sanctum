...
The detailed acceptance record, limitations, receipt references and rollback requirements are in [V1.1 release completion](V1.1-RELEASE-COMPLETION.md) and the [Project 3 structured-editing report](project-3/PROJECT-3-STRUCTURED-EDITING.md). Source disposition remains in the [publication inventory](../../development/PUBLICATION-INVENTORY.md); release and migration procedures are in the [release guide](../../guides/release.md) and [migration guide](../../guides/migration.md).
